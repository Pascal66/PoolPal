...
public class Timer implements Parcelable {
	...
	public static ArrayList<Timer> listFromString(Context ctx, String s) throws ParseException {
		ArrayList<Timer> l = new ArrayList<>();
		String[] _ids = s.split(",");
		for (String _id : _ids) {
	...
	public Timer(Context context, long id) throws ParseException {
		this(context, context.getContentResolver().query(Uri.withAppendedPath(PoolPalContent.TIMERS_CONTENT_URI, Long.toString(id)), TimerTable.columnProjection(), null, null, null));
	}
