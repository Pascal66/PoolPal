...
public class OrderItem {
	...
	public static ArrayList<OrderItem> listFromString(Context ctx, String s) throws ParseException {
		ArrayList<OrderItem> l = new ArrayList<>();
		String[] _ids = s.split(",");
		for (String _id : _ids) {
	...
	public OrderItem(Context context, long id) throws ParseException {
		this(context, context.getContentResolver().query(Uri.withAppendedPath(PoolPalContent.ORDER_ITEMS_CONTENT_URI, Long.toString(id)), OrderItemTable.columnProjection(), null, null, null));
	}
