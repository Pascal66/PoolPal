...
public class Item implements Parcelable {
	...
	public Item(Context context, long id) {
		this(context, context.getContentResolver().query(Uri.withAppendedPath(PoolPalContent.ITEMS_CONTENT_URI, Long.toString(id)), ItemTable.columnProjection(), null, null, null));
	}
