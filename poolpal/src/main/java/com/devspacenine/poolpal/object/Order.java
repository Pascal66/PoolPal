...
public class Order implements Parcelable {
	...
	public Order(Context context, long id) throws ParseException {
		this(context, context.getContentResolver().query(Uri.withAppendedPath(PoolPalContent.ORDERS_CONTENT_URI, Long.toString(id)), OrderTable.columnProjection(), null, null, null));
	}
