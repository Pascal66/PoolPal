...
public class Reminder implements Parcelable {
	...
	public static ArrayList<Reminder> listFromString(Context ctx, String s) throws ParseException {
		ArrayList<Reminder> l = new ArrayList<>();
		String[] _ids = s.split(",");
		for (String _id : _ids) {
	...
	public Reminder(Context context, long id) throws ParseException {
		this(context, context.getContentResolver().query(Uri.withAppendedPath(PoolPalContent.REMINDERS_CONTENT_URI, Long.toString(id)), ReminderTable.columnProjection(), null, null, null));
	}
