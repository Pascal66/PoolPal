...
public class WaterTestTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE + " (_id integer primary key autoincrement, pool_id integer not null, " + "task_id integer not null, date text not null, chlorine real, bromine real, ph real, " + "alkalinity integer, hardness integer, stabilizer integer, " + "temperature integer, tds integer, borate integer, lsi real, " + "rsi real, psi real);";
	...
	public static String[] columnProjection() {
		...
		return new String[]{KEY_ID, KEY_POOL, KEY_TASK, KEY_DATE, KEY_CHLORINE, KEY_BROMINE, KEY_PH, KEY_ALKALINITY, KEY_HARDNESS, KEY_STABILIZER, KEY_TEMPERATURE, KEY_TDS, KEY_BORATE, KEY_LSI, KEY_RSI, KEY_PSI};
	}
	...
	public static String[] concreteColumnProjection() {
		...
		return new String[]{CONCRETE_ID, CONCRETE_POOL, CONCRETE_TASK, CONCRETE_DATE, CONCRETE_CHLORINE, CONCRETE_BROMINE, CONCRETE_PH, CONCRETE_ALKALINITY, CONCRETE_HARDNESS, CONCRETE_STABILIZER, CONCRETE_TEMPERATURE, CONCRETE_TDS, CONCRETE_BORATE, CONCRETE_LSI, CONCRETE_RSI, CONCRETE_PSI};
	}
}
