...
public class AddressTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE + " (_id integer primary key autoincrement, " + "line_one text, line_two text, line_three text, " + "feature text, admin text, locality text, thoroughfare text, " + "country_code text, country_name text, latitude real, longitude real, " + "postal_code text);";
	...
	public static String[] columnProjection() {
		...
		return new String[]{KEY_ID, KEY_LINE_ONE, KEY_LINE_TWO, KEY_LINE_THREE, KEY_FEATURE, KEY_ADMIN, KEY_LOCALITY, KEY_THOROUGHFARE, KEY_COUNTRY_CODE, KEY_COUNTRY_NAME, KEY_LATITUDE, KEY_LONGITUDE, KEY_POSTAL_CODE};
	}
	...
	public static String[] concreteColumnProjection() {
		...
		return new String[]{CONCRETE_ID, CONCRETE_LINE_ONE, CONCRETE_LINE_TWO, CONCRETE_LINE_THREE, CONCRETE_FEATURE, CONCRETE_ADMIN, CONCRETE_LOCALITY, CONCRETE_THOROUGHFARE, CONCRETE_COUNTRY_CODE, CONCRETE_COUNTRY_NAME, CONCRETE_LATITUDE, CONCRETE_LONGITUDE, CONCRETE_POSTAL_CODE};
	}
