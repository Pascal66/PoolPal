...
public class TimerTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE + " (_id integer primary key autoincrement, " + "title text not null, message text not null, start_date text not null, " + "duration integer not null, end_date text not null, " + "notification integer not null, sms integer not null, email integer not null);";
	...
	public static String[] columnProjection() {
		...
		return new String[]{KEY_ID, KEY_TITLE, KEY_MESSAGE, KEY_START_DATE, KEY_DURATION, KEY_END_DATE, KEY_NOTIFICATION, KEY_SMS, KEY_EMAIL};
	}
	...
	public static String[] concreteColumnProjection() {
		...
		return new String[]{CONCRETE_ID, CONCRETE_TITLE, CONCRETE_MESSAGE, CONCRETE_START_DATE, CONCRETE_DURATION, CONCRETE_END_DATE, CONCRETE_NOTIFICATION, CONCRETE_SMS, CONCRETE_EMAIL};
	}
