...
public class OrderTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE + " (_id integer primary key autoincrement, order_number text, " + "date text, subtotal real not null, tax real not null, " + "shipping real not null, savings real not null, total real not null, " + "formatted_subtotal text not null, formatted_tax text not null, " + "formatted_shipping text not null, formatted_savings text not null, " + "formatted_total text not null, cart_id text, hmac text, " + "purchase_url text, currency_code text not null, " + "favorite integer not null, title text);";
	...
	public static String[] columnProjection() {
		...
		return new String[]{KEY_ID, KEY_ORDER_NUMBER, KEY_DATE, KEY_SUBTOTAL, KEY_TAX, KEY_SHIPPING, KEY_SAVINGS, KEY_TOTAL, KEY_FORMATTED_SUBTOTAL, KEY_FORMATTED_TAX, KEY_FORMATTED_SHIPPING, KEY_FORMATTED_SAVINGS, KEY_FORMATTED_TOTAL, KEY_CART_ID, KEY_HMAC, KEY_PURCHASE_URL, KEY_CURRENCY_CODE, KEY_FAVORITE, KEY_TITLE};
	}
	...
	public static String[] concreteColumnProjection() {
		...
		return new String[]{CONCRETE_ID, CONCRETE_ORDER_NUMBER, CONCRETE_DATE, CONCRETE_SUBTOTAL, CONCRETE_TAX, CONCRETE_SHIPPING, CONCRETE_SAVINGS, CONCRETE_TOTAL, CONCRETE_FORMATTED_SUBTOTAL, CONCRETE_FORMATTED_TAX, CONCRETE_FORMATTED_SHIPPING, CONCRETE_FORMATTED_SAVINGS, CONCRETE_FORMATTED_TOTAL, CONCRETE_CART_ID, CONCRETE_HMAC, CONCRETE_PURCHASE_URL, CONCRETE_CURRENCY_CODE, CONCRETE_FAVORITE, CONCRETE_TITLE};
	}
}
