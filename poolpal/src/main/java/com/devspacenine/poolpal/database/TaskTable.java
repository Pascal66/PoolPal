...
public class TaskTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE + " (_id integer primary key autoincrement, pool_id integer, " + "title text not null, date text not null, message text not null, repitition integer, repitition_scale integer, " + "next_on_completion integer not null, reminders text, late_reminders integer not null, timer_id integer, " + "item_id integer, favorite_id integer, completed integer not null, save integer not null, " + "address_id integer, task_type integer not null, tasks text);";
	...
	public static String[] columnProjection() {
		...
		return new String[]{KEY_ID, KEY_POOL, KEY_TITLE, KEY_DATE, KEY_MESSAGE, KEY_REPITITION, KEY_REPITITION_SCALE, KEY_NEXT_ON_COMPLETION, KEY_REMINDERS, KEY_LATE_REMINDERS, KEY_TIMER, KEY_ITEM, KEY_FAVORITE, KEY_COMPLETED, KEY_SAVE, KEY_ADDRESS, KEY_TASK_TYPE, KEY_TASKS};
	}
