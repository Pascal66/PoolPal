...
public class TreatmentTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE + " (_id integer primary key autoincrement, pool_id integer not null, task_id integer, " + "date text not null, chlorine_tabs integer, bromine_tabs integer, sanitizer_size text, " + "chlorine_liquid real, chlorine_granules real, bromine_granules real, salt real, " + "chlorine_shock real, non_chlorine_shock real, quat_algaecide real, " + "polyquat_algaecide real, metal_algaecide real, other_algaecide real, " + "phosphate_remover real, sodium_carbonate real, other_ph_increaser real, borax real, " + "boric_acid real, sodium_bisulfate real, acid real, other_ph_reducer real, " + "hardness_increaser real, stabilizer real, diatomaceous_earth real, " + "net_raked integer not null, skimmer_cleaned integer not null, " + "pump_basket_cleaned integer not null, cleaner_emptied integer not null, " + "vacuumed integer not null, brushed integer not null, backwashed integer not null, " + "filter_washed integer not null, drained integer not null, water_added integer not null);";
	...
	public static String[] columnProjection() {
		...
		return new String[]{KEY_ID, KEY_POOL, KEY_TASK, KEY_DATE, KEY_CHLORINE_TABS, KEY_BROMINE_TABS, KEY_SANITIZER_SIZE, KEY_CHLORINE_LIQUID, KEY_CHLORINE_GRANULES, KEY_BROMINE_GRANULES, KEY_SALT, KEY_CHLORINE_SHOCK, KEY_NON_CHLORINE_SHOCK, KEY_QUAT_ALGAECIDE, KEY_POLYQUAT_ALGAECIDE, KEY_METAL_ALGAECIDE, KEY_OTHER_ALGAECIDE, KEY_PHOSPHATE_REMOVER, KEY_SODIUM_CARBONATE, KEY_OTHER_PH_INCREASER, KEY_BORAX, KEY_BORIC_ACID, KEY_SODIUM_BISULFATE, KEY_ACID, KEY_OTHER_PH_REDUCER, KEY_HARDNESS_INCREASER, KEY_STABILIZER, KEY_DIATOMACEOUS_EARTH, KEY_NET_RAKED, KEY_SKIMMER_CLEANED, KEY_PUMP_BASKET_CLEANED, KEY_CLEANER_EMPTIED, KEY_VACUUMED, KEY_BRUSHED, KEY_BACKWASHED, KEY_FILTER_WASHED, KEY_DRAINED, KEY_WATER_ADDED};
	}
	...
	public static String[] concreteColumnProjection() {
		...
		return new String[]{CONCRETE_ID, CONCRETE_POOL, CONCRETE_TASK, CONCRETE_DATE, CONCRETE_CHLORINE_TABS, CONCRETE_BROMINE_TABS, CONCRETE_SANITIZER_SIZE, CONCRETE_CHLORINE_LIQUID, CONCRETE_CHLORINE_GRANULES, CONCRETE_BROMINE_GRANULES, CONCRETE_SALT, CONCRETE_CHLORINE_SHOCK, CONCRETE_NON_CHLORINE_SHOCK, CONCRETE_QUAT_ALGAECIDE, CONCRETE_POLYQUAT_ALGAECIDE, CONCRETE_METAL_ALGAECIDE, CONCRETE_OTHER_ALGAECIDE, CONCRETE_PHOSPHATE_REMOVER, CONCRETE_SODIUM_CARBONATE, CONCRETE_OTHER_PH_INCREASER, CONCRETE_BORAX, CONCRETE_BORIC_ACID, CONCRETE_SODIUM_BISULFATE, CONCRETE_ACID, CONCRETE_OTHER_PH_REDUCER, CONCRETE_HARDNESS_INCREASER, CONCRETE_STABILIZER, CONCRETE_DIATOMACEOUS_EARTH, CONCRETE_NET_RAKED, CONCRETE_SKIMMER_CLEANED, CONCRETE_PUMP_BASKET_CLEANED, CONCRETE_CLEANER_EMPTIED, CONCRETE_VACUUMED, CONCRETE_BRUSHED, CONCRETE_BACKWASHED, CONCRETE_FILTER_WASHED, CONCRETE_DRAINED, CONCRETE_WATER_ADDED};
	}
}
