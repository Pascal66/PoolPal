...
public class ItemTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE + " (_id integer primary key autoincrement, asin text not null, ean text, " + "isbn text, eisbn text, mpn text, sku text, " + "title text not null, product_group text, manufacturer text, " + "brand text, model text, list_price real, " + "formatted_list_price text, price real not null, " + "formatted_price text not null, currency_code text not null, rating real, " + "url text not null);";
	...
	public static String[] columnProjection() {
		...
		return new String[]{KEY_ID, KEY_ASIN, KEY_EAN, KEY_ISBN, KEY_EISBN, KEY_MPN, KEY_SKU, KEY_TITLE, KEY_PRODUCT_GROUP, KEY_MANUFACTURER, KEY_BRAND, KEY_MODEL, KEY_LIST_PRICE, KEY_FORMATTED_LIST_PRICE, KEY_PRICE, KEY_FORMATTED_PRICE, KEY_CURRENCY_CODE, KEY_RATING, KEY_URL};
	}
	...
	public static String[] concreteColumnProjection() {
		...
		return new String[]{CONCRETE_ID, CONCRETE_ASIN, CONCRETE_EAN, CONCRETE_ISBN, CONCRETE_EISBN, CONCRETE_MPN, CONCRETE_SKU, CONCRETE_TITLE, CONCRETE_PRODUCT_GROUP, CONCRETE_MANUFACTURER, CONCRETE_BRAND, CONCRETE_MODEL, CONCRETE_LIST_PRICE, CONCRETE_FORMATTED_LIST_PRICE, CONCRETE_PRICE, CONCRETE_FORMATTED_PRICE, CONCRETE_CURRENCY_CODE, CONCRETE_RATING, CONCRETE_URL};
	}
}
