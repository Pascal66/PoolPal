...
public class OrderItemTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE + " (_id integer primary key autoincrement, " + "item_id integer not null default 0, " + "order_id integer not null default 0, " + "cart_item_id text, " + "asin text, " + "offer_listing_id text, " + "seller_nickname text, " + "quantity integer not null default 0, " + "title text not null, " + "product_group text, " + "price real not null, " + "total real not null, " + "formatted_price text not null, " + "formatted_total text not null, " + "currency_code text not null);";
	...
	public static String[] columnProjection() {
		...
		return new String[]{KEY_ID, KEY_ITEM, KEY_ORDER, KEY_CART_ITEM_ID, KEY_ASIN, KEY_OFFER_LISTING_ID, KEY_SELLER_NICKNAME, KEY_QUANTITY, KEY_TITLE, KEY_PRODUCT_GROUP, KEY_PRICE, KEY_TOTAL, KEY_FORMATTED_PRICE, KEY_FORMATTED_TOTAL, KEY_CURRENCY_CODE};
	}
	...
	public static String[] concreteColumnProjection() {
		...
		return new String[]{CONCRETE_ID, CONCRETE_ITEM, CONCRETE_ORDER, CONCRETE_CART_ITEM_ID, CONCRETE_ASIN, CONCRETE_OFFER_LISTING_ID, CONCRETE_SELLER_NICKNAME, CONCRETE_QUANTITY, CONCRETE_TITLE, CONCRETE_PRODUCT_GROUP, CONCRETE_PRICE, CONCRETE_TOTAL, CONCRETE_FORMATTED_PRICE, CONCRETE_FORMATTED_TOTAL, CONCRETE_CURRENCY_CODE};
	}
}
