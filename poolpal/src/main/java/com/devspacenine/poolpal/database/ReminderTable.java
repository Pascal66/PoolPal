...
public class ReminderTable {
	...
	private static final String DATABASE_CREATE = "create table " + TABLE + " (_id integer primary key autoincrement, " + "date text not null, period integer not null, notification integer not null, " + "sms integer not null, email integer not null);";
	...
	public static String[] columnProjection() {
		...
		return new String[]{KEY_ID, KEY_DATE, KEY_PERIOD, KEY_NOTIFICATION, KEY_SMS, KEY_EMAIL};
	}
	...
	public static String[] concreteColumnProjection() {
		...
		return new String[]{CONCRETE_ID, CONCRETE_DATE, CONCRETE_PERIOD, CONCRETE_NOTIFICATION, CONCRETE_SMS, CONCRETE_EMAIL};
	}
}
