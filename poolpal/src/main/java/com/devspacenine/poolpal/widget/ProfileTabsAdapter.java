 ...
 * tab changes.
 */
public class ProfileTabsAdapter extends FragmentPagerAdapter implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
	...
	private final ArrayList<TabInfo> mTabsBackStack = new ArrayList<>();
	private androidx.fragment.app.Fragment mInfoFragment;
	private androidx.fragment.app.Fragment mTasksFragment;
	private androidx.fragment.app.Fragment mChartsFragment;
	...
	public ProfileTabsAdapter(FragmentActivity activity, TabHost tabHost, androidx.viewpager.widget.ViewPager pager) {
