...
public abstract class DataAdapter extends BaseAdapter {
	...
	public static Bundle createItem(String title, String details, String action, int requestCode, boolean set) {
	...
	public static Bundle createItem(String title, String details, String action, int requestCode) {
	...
	public DataAdapter(FragmentActivity context, Pool pool, LinkedList<Bundle> data, int resource) {
	...
	public DataAdapter(FragmentActivity context, Pool pool, LinkedList<Bundle> data, int resource, String fragmentTag) {
