...
public class TaskDataAdapter extends DataAdapter {
	...
	public TaskDataAdapter(FragmentActivity context, Task task, LinkedList<Bundle> data, int resource) {
		super(context, task.getPool(), data, resource);
		mTask = task;
	}

	public TaskDataAdapter(FragmentActivity context, Task task, LinkedList<Bundle> data, int resource, String fragmentTag) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewGroup buttonView = v.findViewById(R.id.button);
